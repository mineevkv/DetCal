...
class RSA506N_S21_Parser:
    ...
    def _extract_parameters(self) -> Dict[str, Any]:
        ...
        if "VNA" in self.config:
            ...
            params["stop_freq"] = float(
                vna.get("m_f64StopFreq", "6500000000")
            )  # 6.5 GHz
            params["center_freq"] = float(
                vna.get("m_f64CentFreq", "3250050000")
            )  # 3.25 GHz
    ...
    def _extract_trace_data(self) -> None:
    ...
    def analyze_measurement(self) -> Dict[str, Any]:
        ...
        print(
            f"Frequency range: {self.frequency[0]/1e6:.2f} MHz - {self.frequency[-1]/1e9:.2f} GHz"
        )
    ...
    def save_to_touchstone(self, filename: str) -> None:
